...
whatsapp_number = "+62 877-5341-5685"
pesan = "saya juga sayanggg sama kamuu"
...
def buka_whatsapp():
    ...
    webbrowser.open_new(f"https://api.whatsapp.com/send?phone=(+62 877-5341-5685)&text={encoded_message}")
